# Isle.Computer - Nexys Video Build Script (Chapter 7)
# Copyright Will Green and Isle Contributors
# SPDX-License-Identifier: MIT

# Build Settings
set design_name "ch07"
set arch "xc7-dvi"
...
# Common Verilog
read_verilog "${lib_dir}/book/ch07/ch07.v"
read_verilog "${lib_dir}/cpu/FemtoRV32.v"
read_verilog "${lib_dir}/devs/dev_display.v"
read_verilog "${lib_dir}/devs/dev_earthrise.v"
