# Isle.Computer - Nexys Video Board Constraints (Chapter 6)
...
## UART
set_property -dict {PACKAGE_PIN V18  IOSTANDARD LVCMOS33} [get_ports { uart_rx}];  # UART receive to Isle
set_property -dict {PACKAGE_PIN AA19 IOSTANDARD LVCMOS33} [get_ports { uart_tx}];  # UART transmit from Isle
