...
Isle currently targets three dev boards and one simulator (no dev board required). Learn more about board support from the [Isle Dev Boards](http://projectf.io/isle/dev-boards.html) blog post.
