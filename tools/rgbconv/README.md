...
Isle uses 15-bit colour (RGB555), but most contemporary systems use 24-bit RGB888. The **rgbconv** tool converts to/from 15-bit and 24-bit string formats. It's written in Python, reads from stdin, and outputs to stdout.
