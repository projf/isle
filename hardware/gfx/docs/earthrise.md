...
This document provides a summary of the hardware module. See [Earthrise Programming](../../../docs/earthrise-programming.md) for guidance on drawing pixels, lines, and shapes.
