...
module FemtoRV32 #(
    parameter ADDRW=32,       // byte address bus width
    ...
    // state machine (moved to avoid declaration after use)
   ...
   /***************************************************************************/
    ...
    /**************************************************************************/
    // Use same shifter both for left and right shifts by applying bit reversal
