...
COMPILE_ARGS += -P${DUT}.DISPLAY_MODE=3 -P${DUT}.FILE_FONT="\"../../../res/fonts/system-font-rom.mem"\" -P${DUT}.FILE_PAL="\"../../../res/palettes/go-16.mem"\" -P${DUT}.FILE_TXT="\"../../../res/textmaps/edge-84x24.mem"\" -P${DUT}.WIN_START=32\'h00000000 -P${DUT}.WIN_END=32\'h018002A0 -P${DUT}.TEXT_SCALE=32\'h00010001
