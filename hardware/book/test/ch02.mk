...
COMPILE_ARGS += -P${DUT}.DISPLAY_MODE=3 -P${DUT}.CANV_BPP=2 -P${DUT}.CANV_SCALE=16\'d1 -P${DUT}.WIN_WIDTH=16\'d672 -P${DUT}.WIN_HEIGHT=16\'d384 -P${DUT}.WIN_STARTX=16\'d0 -P${DUT}.WIN_STARTY=16\'d0 -P${DUT}.FILE_BMAP="\"../../../res/bitmaps/latency/latency-672x384.mem"\" -P${DUT}.FILE_PAL="\"../../../res/bitmaps/latency/latency-672x384_palette.mem"\"
